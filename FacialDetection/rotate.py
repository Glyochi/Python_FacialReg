...
def rotateClockwise(img, angle):
    """
    This functions return a clockwise rotated image without cropping any part of the original image. The returned image may have larger dimensions than the original but as small as possible.
...
def rotateCounterClockwise(img, angle):
    """
    This functions return a counter-clockwise rotated image without cropping any part of the original image. The returned image may have larger dimensions than the original but as small as possible.
        @param img: the original image
        @param angle: the rotating angle counter-clockwise
        @return: the rotated image without cropping
    """
